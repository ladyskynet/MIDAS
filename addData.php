						...
						<form action="addDataNow.php" method="post" enctype="multipart/form-data">
							<div class="row uniform">
								<div class="6u 12u$(xsmall)">
									<label for="dset_name">Data Set Name</label>
									<input type="text" name="dset_name" value="" placeholder="Data Set Name" required/>
								</div>
								
								<div class="12u$">
									<ul class="actions">
										<li><input type="submit" value="Next" name="addName" class="special"></li>
